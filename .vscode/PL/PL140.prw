...
User Function PL140()
	...
	aAdd(aColunas, {"Item Cliente"	, "TT_ITEM"		, "C", 15, 0, "@!"})
...
Static Function MenuDef()
	Local aRotina := {}
	ADD OPTION aRotina TITLE "Visualizar" ACTION "VIEWDEF.PL140" OPERATION 1 ACCESS 0
Return aRotina
...
Static Function ModelDef()
	...
	oStTMP:AddTable(cAliasTT, {'TT_PROD', 'TT_DESC', 'TT_CLIENT', 'TT_SALDO', 'TT_LOTE',}, "Temporaria")
...
Static Function ViewDef()
	...
	oStTmp:AddField("TT_LOTE"		,"07","Lote"		,"Lote"			,Nil,"C","@!",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_EMPENHO"	,"08","Empenho"		,"Empenho"		,Nil,"N","@E 9,999,999.99",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
...
Static Function CargaTT()
	...
	While (cAlias)->(!EOF())
		...
		cSql += "	ID, TT_PRODUTO, TT_DESC, TT_CLIENT, TT_SALDO, TT_LOTE, TT_EMPENHO, TT_TIPO, TT_ITEM) VALUES ('"
		cSql += FWUUIDv4() 			 				+ "','"
