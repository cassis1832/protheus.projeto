...
User Function PL070()
	...
	aAdd(aCampos, {"TT_XCLIENT"	,"C", 20, 0})
	aAdd(aCampos, {"TT_XLINPRD"	,"C", 15, 0})
	...
	aAdd(aColunas, {"Linha"		, "TT_XLINPRD"	, "C", 10, 0, "@!"})
	aAdd(aColunas, {"Cliente"	, "TT_XCLIENT"	, "C", 10, 0, "@!"})
	aAdd(aColunas, {"Codigo"	, "TT_PROD"		, "C", 06, 0, "@!"})
	aAdd(aColunas, {"Descricao"	, "TT_DESC"		, "C", 40, 0, "@!"})
	aAdd(aColunas, {"OP"		, "TT_OP"		, "C", 08, 0, "@!"})
	aAdd(aColunas, {"Emissao"	, "TT_EMISSAO"	, "D", 08, 0, "@D"})
...
Static Function ModelDef()
	...
	oStTMP:AddTable(cAliasTT, {'TT_XLINPRD', 'TT_XCLIENT', 'TT_PROD', 'TT_DESC', 'TT_OP', 'TT_INI', 'TT_FIM', 'TT_QUANT', 'TT_QUJE', 'TT_SALDO', 'TT_TPOP', 'TT_EMISSAO'}, "Temporaria")

	//Adiciona os campos da estrutura
	oStTmp:AddField("Linha"		,"Linha"		,"TT_XLINPRD"	,"C",06,00,Nil,Nil,{},.T.,FwBuildFeature(STRUCT_FEATURE_INIPAD, "Iif(!INCLUI,"+cAliasTT+"->TT_XLINPRD,'')" ), .T., .F., .F.)
	oStTmp:AddField("Cliente"	,"Cliente"		,"TT_XCLIENT"	,"C",06,00,Nil,Nil,{},.T.,FwBuildFeature(STRUCT_FEATURE_INIPAD, "Iif(!INCLUI,"+cAliasTT+"->TT_XCLIENT,'')" ), .T., .F., .F.)
	...
	oStTmp:AddField("Tipo"		,"Tipo da OP"	,"TT_TPOP"		,"C",01,00,Nil,Nil,{},.F.,FwBuildFeature(STRUCT_FEATURE_INIPAD, "Iif(!INCLUI,"+cAliasTT+"->TT_TPOP,'')" ),.F.,.F.,.F.)
...
Static Function ViewDef()
	...
	oStTmp:AddField("TT_XCLIENT","02","Cliente"		,"Cliente"		,Nil,"C","@!",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_PROD"	,"03","Codigo"		,"Codigo"		,Nil,"C","@!",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_DESC"	,"04","Descricao"	,"Descricao"	,Nil,"C","@!",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_OP"		,"05","Ordem"		,"Ordem"		,Nil,"C","@!",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_EMISSAO","06","Emissao"		,"Emissao"		,Nil,"D","@D",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_INI"	,"07","Data Ini."	,"Data Ini."	,Nil,"D","@D",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_FIM"	,"08","Data Fim"	,"Data Fim"		,Nil,"D","@D",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_QUANT"	,"09","Quant."		,"Quantidade"	,Nil,"N","@E 9,999,999.99",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_QUJE"	,"10","Prod."		,"Produzida"	,Nil,"N","@E 9,999,999.99",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_SALDO"	,"11","Saldo"		,"Saldo"		,Nil,"N","@E 9,999,999.99",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
	oStTmp:AddField("TT_TPOP"	,"12","Tipo"		,"Tipo"			,Nil,"C","@!",Nil,Nil,.T.,Nil,Nil,Nil,Nil,Nil,Nil,Nil,Nil)
...
Static Function CargaTT()
	...
	cSql += "	 CAST(C2_DATPRF AS DATE) C2_DATPRF, C2_TPOP, CAST(C2_EMISSAO AS DATE) C2_EMISSAO, "
	...
	cSql += "ORDER BY B1_XLINPRD, C2_DATPRF, C2_NUM, C2_ITEM, C2_SEQUEN "
