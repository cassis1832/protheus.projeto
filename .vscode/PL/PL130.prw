...
User Function PL130()
	...
	DEFINE SBUTTON oSButton1 FROM 020, 280 TYPE 06 OF oDlg ENABLE ACTION Imprimir(aWBrowse1)
	DEFINE SBUTTON oSButton2 FROM 020, 310 TYPE 17 OF oDlg ENABLE ACTION Filtrar(dDtIni, dDtFim)
