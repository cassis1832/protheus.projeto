...
Static Function Processa(oSay)
	...
	While (cAlias)->(! EOF())
		...
		cSql += " TT_SETUP, TT_QTHS, TT_QTHSTOT, TT_XLIN, TT_XLOCLIN, TT_XTIPO, TT_XITEM, TT_XNOME,"
...
Static Function GravaCSV(oSay)
	...
	If (oFile:Create())
		...
		While (cAlias)->(! EOF())
			...
			cLinha += AllTrim((cAlias)->TT_XNOME) + ";"
