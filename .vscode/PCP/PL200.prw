...
Static Function MenuDef()
	Local aRot := {}
	ADD OPTION aRot TITLE 'Gerar Pedidos'  ACTION 'U_PL200Gerar()' OPERATION MODEL_OPERATION_VIEW ACCESS 0 
Return aRot
...
Static Function ModelDef()
	...
	oModel:=MPFormModel():New("PL200PE",,,,) 
...
Static Function ViewDef()
    Local oView  := Nil
    Local oModel := FWLoadModel("PL200")      
