...
User Function ETQPROC()
	...
	cQuery += "       CAST(C2_DATPRI AS DATE) C2_DATPRI, "
...
Static Function etqproci(cAliasOrd)
	...
	For nX := 1 to nEtiquetas
		...
		MSCBWrite("^FO16,408^GB767,96,6^FS" + ENTER)
		MSCBWrite("^FO527,311^GB256,80,6^FS" + ENTER)
		MSCBWrite("^FO607,215^GB176,80,6^FS" + ENTER)
		MSCBWrite("^FO431,215^GB160,80,6^FS" + ENTER)
		...
		MSCBWrite("^FO271,311^GB240,80,6^FS" + ENTER)
		MSCBWrite("^FO16,311^GB240,80,6^FS" + ENTER)
		...
		MSCBWrite("^FO239,215^GB176,80,6^FS" + ENTER)
		MSCBWrite("^FO16,215^GB208,80,6^FS" + ENTER)
		MSCBWrite("^FO431,119^GB352,80,6^FS" + ENTER)
		MSCBWrite("^FO248,119^GB176,80,6^FS" + ENTER)
		MSCBWrite("^FO464,23^GB319,80,6^FS" + ENTER)
		MSCBWrite("^FO16,23^GB171,80,6^FS" + ENTER)
		...
		MSCBWrite("^FO337,23^GB113,80,6^FS" + ENTER)
		MSCBWrite("^FO205,23^GB125,80,6^FS" + ENTER)
		MSCBWrite("^FO19,119^GB205,80,6^FS" + ENTER)
		...
		MSCBWrite("^FT758,324^A0I,51,51^FH\^CI28^FD"+AllTrim("HWASHIN")+"^FS^CI27" + ENTER)
		MSCBWrite("^FT738,428^A0I,62,94^FH\^CI28^FD"+AllTrim("71584-BW000 (R)")+"^FS^CI27" + ENTER)
		MSCBWrite("^FT709,34^A0I,69,74^FH\^CI28^FD"+AllTrim("003.978")+"^FS^CI27" + ENTER)
