...
//-------------------------------------------------------------------
/*/{Protheus.doc} ETQMTR
Impress�o Etiqueta Cliente GKTB
...
//	Local nRadMenu2 := 2
	...
	DEFINE MSDIALOG oDlg TITLE "Emiss�o de Etiqueta" FROM 000, 000  TO 450, 800 COLORS 0, 16777215 PIXEL
...
Static Function fWBrowse1()
	...
	@ 068, 005 LISTBOX oWBrowse1 Fields HEADER " ","Qtd Impre","Pedido","Nota Fiscal","Serie","Cliente","Nome","Produto","Descri��o","Quantidade","Lote","Emiss�o","Esp�cie","Peso Liq.","Cod. Prod. Cliente","Descr. Prod. Cliente","End. Cliente" SIZE 390, 152 OF oDlg PIXEL ColSizes 50,50
...
STATIC FUNCTION ETQMTRB(aDados)
	...
	ELSE
		Aviso("Aten��o","N�o a Dados para ser impresso!",{"Ok"})
	endif
Return
//-------------------------------------------------------------------
...
cria��o da estrutura de pergunte
@author  Vinicius Pereira
@since   08/03/2022
@version 1.0
/*/
...
Static Function CriaSx1(cPerg)
	...
	aAdd(aReg,{cPerg,"01","Porta de impress�o"  ,"mv_ch1","C",45,0,0,"G","","mv_par01","","LPT1","","","","","","","","","","","","",""})
...
/*/{Protheus.doc} EtqCli
rotina de impress�o via impressora termica ZEBRA
	...
	For nX:=1 to len(aDados)
		If aDados[nX][1]
			For nY:=1 to aDados[nX][2]
				...
				MSCBWrite("^FT540,665^A0N,70,50^FH\^FD"+AllTrim(aDados[nX][17])+"^FS" +ENTER) //Endere�o g-ktb
