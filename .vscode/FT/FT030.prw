...
Static Function MenuDef()
	...
	ADD OPTION aRot TITLE 'Visualizar' 	  ACTION 'VIEWDEF.FT030' 	OPERATION 2 ACCESS 0 
	ADD OPTION aRot TITLE 'Alterar'    	  ACTION 'VIEWDEF.FT030' 	OPERATION 4 ACCESS 0 
	ADD OPTION aRot TITLE 'Excluir'    	  ACTION 'VIEWDEF.FT030' 	OPERATION 5 ACCESS 0 
	ADD OPTION aRot TITLE 'Gerar Pedidos' ACTION 'u_FT030Mark()'	OPERATION 6 ACCESS 0 
	ADD OPTION aRot TITLE 'Legenda'    	  ACTION 'u_FT030Leg' 	 	OPERATION 8 Access 0       
Return aRot
...
Static Function ViewDef()
    Local oView  := Nil
    Local oModel := FWLoadModel("FT030")      
